...
En el navegador, inicie sesión en Github. Luego, vaya al enlace del proyecto original (https://github.com/JohnSovero/model-insurance-cross-selling) y dé click al botón "Fork". Esto copiará todo el proyecto en su usuario de Github.
...
```
git clone https://github.com/<USER>/model-insurance-cross-selling.git
```
...
```
cd model-insurance-cross-selling/
